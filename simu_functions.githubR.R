...
simu_quadraGauss_output = function(design, pmain, nb = 3, heredity = "strong",
  ...
  if(is.null(true_beta)){
    ...
    if(heredity == "strong"){
      ...
      non_0_interac_idx = apply(gtools::combinations(n=nb,r=2,repeats.allowed = F, v = non_0_main_idx),1,
...
make_interac_names = function(pmain){
  num_names = gtools::combinations(n = pmain, r = 2, v = 1:pmain, repeats.allowed = F)
